...
INCDIR	     ?= ./inc
CUDADIR      := /usr/local/cuda-7.5/targets/x86_64-linux
...
# Includes
INCLUDES  += -I$(INCDIR) -I$(OCLCOMMONDIR)/inc -I$(SHAREDDIR)/inc -I$(CUDADIR)/include
...
ifneq ($(STATIC_LIB),)
	...
	LIB += -loclUtil_$(LIB_ARCH)$(LIBSUFFIX) -lshrutil_$(LIB_ARCH)$(LIBSUFFIX) -lclpp
